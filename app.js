...
window.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("scroll", function () {
    ...
    scrolled > 1000 ? bookMark.classList.add("displayBookmark") : bookMark.classList.remove("displayBookmark");
    // **** condition for fixed navbar ****
    scrolled > navHeight? nav.classList.add('fixed-nav') : nav.classList.remove('fixed-nav');
  });
});
